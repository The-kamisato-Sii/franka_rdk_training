...
export REAL_WORLD_FRANKA_DUAL_ROOT=${REAL_WORLD_FRANKA_DUAL_ROOT:-/inspire/qb-ilm2/project/robot-body/public/bokai/franka_dual_test_new}
export RUN_LOG_PATH=${RUN_LOG_PATH:-/inspire/hdd/project/robot-body/linbokai-CZXS24250037/results}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-real_world_franka_dual_openpi_pi05_sft_arrange_vegetables_v5}
