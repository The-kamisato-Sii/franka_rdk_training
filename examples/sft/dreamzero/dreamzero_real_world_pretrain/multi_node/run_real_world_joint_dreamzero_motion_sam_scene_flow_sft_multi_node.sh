...
export RUN_LOG_PATH=${RUN_LOG_PATH:-/inspire/hdd/project/robot-body/linbokai-CZXS24250037/RLinf/results_v3}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-real_world_joint_sft_dreamzero_motion_sam_scene_flow_5b_v3}
